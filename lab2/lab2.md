...
![image-20230325152416070](C:\Users\wmy\AppData\Roaming\Typora\typora-user-images\image-20230325152416070.png)
...
def myNetwork():
    ...
    info( '*** Add links\n')
    net.addLink(h1, s1)
    net.addLink(s1, s2, bw=20, loss=5)
    net.addLink(s2, h2)
    net.addLink(h4, s1)
    net.addLink(s1, s3, bw=20, loss=5)
    net.addLink(h3, s3)
...
![image-20230325152706079](C:\Users\wmy\AppData\Roaming\Typora\typora-user-images\image-20230325152706079.png)
...
![](C:\Users\wmy\AppData\Roaming\Typora\typora-user-images\image-20230325153234644.png)
...
![image-20230329220027626](C:\Users\wmy\AppData\Roaming\Typora\typora-user-images\image-20230329220027626.png)

After we add another link between s2 and s3, the hosts' connectivity is broken.

So we use OVS commands to set up flow rules and restore the connectivity.
